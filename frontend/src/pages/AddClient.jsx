...
const AddClient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     const payload = {
      ...
      const res = await axios.post(`${import.meta.env.VITE_BASE_URL}/client/addClient`, payload);
    //   console.log(res);
      ...
      setMessage("❌ Error adding client: " + (err.response?.data?.error || err.message));
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#0B1623] px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-center space-x-4 mt-6">
            ...
            <button
              ...
              className="border border-gray-400 text-gray-700 font-medium px-6 py-2 rounded-md hover:bg-gray-100 transition"
            >
              Cancel
            </button>
          </div>
